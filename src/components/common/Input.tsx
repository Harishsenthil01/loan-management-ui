...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, hint, showPasswordToggle, type = 'text', className = '', id, ...rest }, ref) => {
    const autoId = useId();
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <input
            ...
            className={[
              'w-full rounded-lg border px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400',
